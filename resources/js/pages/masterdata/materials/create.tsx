...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah Material', href: '/masterdata/materials/create' },
];

export default function CreateMaterial({ categories }: Props) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="mb-4 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold">Tambah Material Baru</h1>
                        <p className="text-muted-foreground">
                            Tambahkan material atau bahan baku baru
                        </p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Isi formulir di bawah ini untuk menambahkan material baru
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
