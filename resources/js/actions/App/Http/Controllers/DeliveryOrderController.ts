...
/**
* @see \App\Http\Controllers\DeliveryOrderController::generatePdf
 * @see app/Http/Controllers/DeliveryOrderController.php:282
 * @route '/penjualan/delivery-orders/{deliveryOrder}/pdf'
 */
export const generatePdf = (args: { deliveryOrder: number | { id: number } } | [deliveryOrder: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/penjualan/delivery-orders/{deliveryOrder}/pdf'
 */
generatePdf.url = (args: { deliveryOrder: number | { id: number } } | [deliveryOrder: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
 ...
 * @route '/penjualan/delivery-orders/{deliveryOrder}/pdf'
 */
generatePdf.get = (args: { deliveryOrder: number | { id: number } } | [deliveryOrder: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: generatePdf.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/penjualan/delivery-orders/{deliveryOrder}/pdf'
 */
generatePdf.head = (args: { deliveryOrder: number | { id: number } } | [deliveryOrder: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: generatePdf.url(args, options),
    method: 'head',
})
 ...
 * @route '/penjualan/delivery-orders/{deliveryOrder}/pdf'
 */
    const generatePdfForm = (args: { deliveryOrder: number | { id: number } } | [deliveryOrder: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/penjualan/delivery-orders/{deliveryOrder}/pdf'
 */
        generatePdfForm.get = (args: { deliveryOrder: number | { id: number } } | [deliveryOrder: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: generatePdf.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/penjualan/delivery-orders/{deliveryOrder}/pdf'
 */
        generatePdfForm.head = (args: { deliveryOrder: number | { id: number } } | [deliveryOrder: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
const DeliveryOrderController = { index, create, store, show, edit, update, destroy, generatePdf }
