 ...
 * @route '/masterdata/products/create'
 */
 ...
 * @route '/masterdata/products/{product}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: '/masterdata/products/{product}',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/masterdata/products/{product}/edit'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/masterdata/products/{product}/edit',
} satisfies RouteDefinition<["get","head"]>
